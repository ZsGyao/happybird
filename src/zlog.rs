...
macro_rules! log {
    ($logger:expr, $level:expr, $($arg:tt)+) => {
        let level = $level;
        let logger = $logger;
        let enabled = $crate::zlog::filter::is_scope_enabled(&logger.scope, Some(module_path!()), level);
        if enabled {
            $crate::zlog::sink::submit($crate::zlog::sink::Record {
                scope: logger.scope,
                level,
...
macro_rules! trace {
    ($logger:expr => $($arg:tt)+) => {
        $crate::log!($logger, $crate::zlog::log_impl::Level::Trace, $($arg)+);
    };
    ($($arg:tt)+) => {
        $crate::log!($crate::default_logger!(), $crate::zlog::log_impl::Level::Trace, $($arg)+);
    };
}
...
macro_rules! debug {
    ($logger:expr => $($arg:tt)+) => {
        $crate::log!($logger, $crate::zlog::log_impl::Level::Debug, $($arg)+);
    };
    ($($arg:tt)+) => {
        $crate::log!($crate::default_logger!(), $crate::zlog::log_impl::Level::Debug, $($arg)+);
    };
}
...
macro_rules! info {
    ($logger:expr => $($arg:tt)+) => {
        $crate::log!($logger, $crate::zlog::log_impl::Level::Info, $($arg)+);
    };
    ($($arg:tt)+) => {
        $crate::log!($crate::default_logger!(), $crate::zlog::log_impl::Level::Info, $($arg)+);
    };
}
...
macro_rules! warn {
    ($logger:expr => $($arg:tt)+) => {
        $crate::log!($logger, $crate::zlog::log_impl::Level::Warn, $($arg)+);
    };
    ($($arg:tt)+) => {
        $crate::log!($crate::default_logger!(), $crate::zlog::log_impl::Level::Warn, $($arg)+);
    };
}
...
macro_rules! error {
    ($logger:expr => $($arg:tt)+) => {
        $crate::log!($logger, $crate::zlog::log_impl::Level::Error, $($arg)+);
    };
    ($($arg:tt)+) => {
        $crate::log!($crate::default_logger!(), $crate::zlog::log_impl::Level::Error, $($arg)+);
    };
}
...
macro_rules! default_logger {
    () => {
        $crate::zlog::Logger {
            scope: $crate::zlog::private::scope_new(&[$crate::crate_name!()]),
        }
    };
}
...
macro_rules! crate_name {
    () => {
        $crate::zlog::private::extract_crate_name_from_module_path(module_path!())
    };
}
